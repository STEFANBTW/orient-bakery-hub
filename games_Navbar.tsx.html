...
export const Navbar: React.FC<NavbarProps> = ({ onNavigate }) => {
    return (
        <nav className="fixed top-0 w-full z-[60] bg-[#050505]/90 backdrop-blur-md border-b border-white/10">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-20">
                    <div className="flex items-center gap-2 cursor-pointer group" onClick={() => onNavigate(Page.HOME)}>
