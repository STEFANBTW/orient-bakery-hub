    ...
    <div className="bg-[#050505] font-newsreader text-white min-h-screen selection:bg-primary-gold selection:text-black">
      ...
      <section className="py-24 px-6 max-w-[1400px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {[
            { 
              name: 'The Obsidian', price: '$24', 
              desc: 'Smoked maple wood, rye whiskey, angostura bitters, activated charcoal essence.',
              tags: ['Smoked', 'Strong'],
              img: 'https://images.unsplash.com/photo-1595981267035-7b04ca84a82d?auto=format&fit=crop&q=80&w=800'
            },
            { 
              name: 'Silk Route', price: '$22', 
              desc: 'Botanical gin, jasmine tea syrup, egg white foam, dusted with matcha.',
              tags: ['Floral', 'Smooth'],
              img: 'https://images.unsplash.com/photo-1556679343-c7306c1976bc?auto=format&fit=crop&q=80&w=800'
            },
            { 
              name: 'Golden Geisha', price: '$28', 
            ...
            { 
              name: 'Midnight Espresso', price: '$20', 
            ...
            { 
              name: 'Spiced Pear Mule', price: '$21', 
            ...
            { 
              name: 'Velvet Revolver', price: '$23', 
              desc: 'Bourbon, crème de cassis, fresh lemon, blackberries, thyme sprig.',
              tags: ['Fruity', 'Herbal'],
      ...
      <section className="py-32 bg-[#080808] relative">
        <div className="max-w-[1400px] mx-auto px-6 relative z-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            {[
              {
                name: 'Wagyu A5 Tataki',
                price: '$85',
                desc: 'Flash-seared Miyazaki beef, truffle ponzu, crispy garlic.',
                detail: 'Rare',
              ...
              },
              {
                ...
                price: '$48',
                desc: '12-hour shoulder, pomegranate molasses, pistachio dukkah.',
                detail: 'Succulent',
      ...
      <section className="py-32 px-6 max-w-[1400px] mx-auto border-b border-white/5">
         ...
         <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
            {[
              { name: 'Macallan M', price: '$450', origin: 'Highland', img: 'https://images.unsplash.com/photo-1527281032555-60dec035c93f?auto=format&fit=crop&q=80&w=800' },
              { name: 'Louis XIII', price: '$380', origin: 'Cognac', img: 'https://images.unsplash.com/photo-1569529465841-dfecd798f639?auto=format&fit=crop&q=80&w=800' },
              { name: 'Hibiki 30', price: '$500', origin: 'Japan', img: 'https://images.unsplash.com/photo-1517551694605-ffbb87886475?auto=format&fit=crop&q=80&w=800' },
              { name: 'Pappy 23', price: '$220', origin: 'Kentucky', img: 'https://images.unsplash.com/photo-1598155523122-38423bb4d6c1?auto=format&fit=crop&q=80&w=800' },
              { name: 'Clase Azul', price: '$300', origin: 'Mexico', img: 'https://images.unsplash.com/photo-1516535794938-606387ce567e?auto=format&fit=crop&q=80&w=800' }
            ].map((spirit, i) => (
      ...
      <section className="py-32 px-6 max-w-[1400px] mx-auto">
         ...
         <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
            {[
              { name: 'Château Margaux', price: '$1,800', origin: 'Bordeaux', img: 'https://images.unsplash.com/photo-1506377247377-2a5b3b417ebb?auto=format&fit=crop&q=80&w=800' },
              { name: 'Opus One 2018', price: '$650', origin: 'Napa Valley', img: 'https://images.unsplash.com/photo-1584916201218-f4242ceb4809?auto=format&fit=crop&q=80&w=800' },
              { name: 'Penfolds Grange', price: '$950', origin: 'Australia', img: 'https://images.unsplash.com/photo-1559563362-c667ba5f5480?auto=format&fit=crop&q=80&w=800' },
              { name: 'Tignanello', price: '$420', origin: 'Tuscany', img: 'https://images.unsplash.com/photo-1510812431401-41d2bd2722f3?auto=format&fit=crop&q=80&w=800' },
              { name: 'Dom Pérignon', price: '$750', origin: 'Champagne', img: 'https://images.unsplash.com/photo-1594453000627-c1d4791723f5?auto=format&fit=crop&q=80&w=800' }
            ].map((wine, i) => (
              <div key={i} className="group cursor-pointer">
                 <div className="aspect-[3/4] overflow-hidden rounded-sm mb-6 relative">
      ...
      {/* Footer */}
      <footer className="py-24 bg-black border-t border-white/5 text-center relative overflow-hidden">
        <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/dark-leather.png')] opacity-10"></div>
        <div className="relative z-10">
          <span className="material-icons text-primary-gold/50 text-2xl mb-6">diamond</span>
          <p className="text-primary-gold italic text-3xl mb-6 font-serif">Orient Lounge</p>
          <p className="font-display text-gray-600 text-[10px] uppercase tracking-[0.3em] mb-8">
            All prices subject to service charge and tax.
          </p>
          <div className="flex justify-center gap-6">
             <button className="px-6 py-3 border border-white/10 text-[10px] uppercase tracking-widest hover:bg-white hover:text-black transition-all">Download PDF</button>
             <button className="px-6 py-3 border border-white/10 text-[10px] uppercase tracking-widest hover:bg-primary-gold hover:text-black hover:border-primary-gold transition-all">Book Tasting</button>
          </div>
        </div>
      </footer>
    </div>
