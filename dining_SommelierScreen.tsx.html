...
const SommelierScreen: React.FC = () => {
    return (
        <div className="bg-background-light dark:bg-background-dark text-gray-800 dark:text-gray-200 font-sans">
             {/* Hero */}
                ...
                <div className="max-w-5xl mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                        <div className="lg:col-span-5 space-y-6">
                            <h2 className="text-4xl font-bold text-gray-900 dark:text-white">Ask the <span className="text-primary">Sommelier</span></h2>
                            ...
                            <div className="flex items-center gap-4 pt-4">
                                <div className="h-12 w-12 rounded-full bg-neutral-dark flex items-center justify-center border border-primary/20">
                                    <span className="material-icons text-primary">auto_awesome</span>
                                </div>
                                <div>
                                    <p className="text-sm font-bold text-white">AI-Powered</p>
                                    <p className="text-xs text-gray-500">Curated by taste algorithms</p>
                                </div>
                            </div>
                        </div>
                        <div className="lg:col-span-7">
                            <div className="glass-card rounded-xl border border-primary/20 p-8 shadow-2xl relative overflow-hidden group">
                                <div className="absolute -top-20 -right-20 w-64 h-64 bg-primary/20 rounded-full blur-[100px] pointer-events-none"></div>
                                <div className="relative z-10 space-y-6">
                                    <label className="block text-sm font-medium text-gray-400 uppercase tracking-wider">Describe your dish</label>
                                    <div className="relative">
                                        <input className="w-full bg-neutral-dark/50 border border-neutral-mid text-white placeholder-gray-500 rounded-lg py-4 px-5 focus:ring-2 focus:ring-primary focus:border-transparent outline-none transition-all" placeholder="I'm having the Spicy Prawn Curry..." type="text"/>
                                        <span className="material-icons absolute right-4 top-4 text-gray-500">search</span>
                                    </div>
                                    <button className="w-full bg-primary hover:bg-primary/90 text-white font-semibold py-4 rounded-lg flex items-center justify-center gap-2 transition-all shadow-lg shadow-primary/20">
             ...
             {/* Heritage Series */}
             <section className="py-32 bg-neutral-dark relative" id="heritage">
                 <div className="max-w-7xl mx-auto px-6">
                     <div className="text-center mb-20">
                        <span className="text-primary text-sm font-bold uppercase tracking-widest">Heritage Series</span>
                        <h2 className="text-5xl font-display font-bold text-white mt-4 mb-6">Science of the Soil</h2>
                     ...
                     <div className="grid grid-cols-1 md:grid-cols-2 gap-16 mb-32 items-center">
                         <div className="relative group">
                             <div className="absolute inset-0 bg-primary/20 rounded-xl transform rotate-3 group-hover:rotate-6 transition-transform duration-500"></div>
                             <img src="https://lh3.googleusercontent.com/aida-public/AB6AXuBssD_LUthXyTrwE5u26YoXMuQz_4PwGCza5PZSPuQRrv0ZR7m2-1PjHLbKQ_ruFIJyaIiP8jUDyoExceYap7PfPT7kNUKFer0B4-7avuqf-bWlBpwWxyFDtcWP_0IvWFTmfScv6EDeL_6TykrDUjFFdS_10BGP24cACWN64T3etH-OwlqE1cmF8NIPeFim7LiLTbi_eSN38XnFVf8cFBBlfVNk2TGKBg4ukOZJ0zQeywW1fSQTXid-wljZccGPdLNgIYDUkS2JPS3i" className="relative rounded-xl shadow-2xl z-10 w-full h-[500px] object-cover filter brightness-90 contrast-110" alt="Zobo" />
                         </div>
                         <div className="space-y-8">
                             <div>
                                 <h3 className="text-3xl font-bold text-white mb-2">The Zobo Infusion</h3>
                                 <p className="text-primary font-medium">Hibiscus Sabdariffa</p>
                             </div>
                             ...
                             <div className="grid grid-cols-3 gap-4 pt-4 border-t border-white/10">
                                <div>
                                    ...
                                    <span className="text-xs text-gray-500 uppercase">Steeping Time</span>
                                </div>
                                <div>
                                    <span className="block text-2xl font-bold text-white">3.2</span>
                                    <span className="text-xs text-gray-500 uppercase">pH Level</span>
                                </div>
                                <div>
                                    <span className="block text-2xl font-bold text-white">0%</span>
                                    <span className="text-xs text-gray-500 uppercase">Alcohol</span>
                                </div>
                             </div>
                         </div>
                     </div>
                     ...
                     <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                        <div className="order-2 md:order-1 space-y-8">
                            <div>
                                <h3 className="text-3xl font-bold text-white mb-2">The Kunu Fermentation</h3>
                                <p className="text-primary font-medium">Millet & Sorghum</p>
                            </div>
                            <div className="prose prose-invert prose-lg text-gray-400 font-light">
                                <p className="mb-4">
             ...
             {/* Wine & Malt List */}
            <section className="py-24 bg-background-light dark:bg-background-dark overflow-hidden" id="wines">
                <div className="max-w-6xl mx-auto px-6">
                    <div className="flex flex-col md:flex-row justify-between items-end mb-16 border-b border-primary/20 pb-6">
                        <div>
                            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-2">The Reserve List</h2>
                            <p className="text-gray-500 dark:text-gray-400">Curated specifically for the Orient palate.</p>
                        </div>
                        <div className="flex gap-4 mt-6 md:mt-0">
                            <button className="px-4 py-2 rounded-full bg-primary text-white text-sm">Reds</button>
                            <button className="px-4 py-2 rounded-full border border-gray-700 text-gray-500 hover:text-primary dark:text-gray-400 text-sm">Whites</button>
                            <button className="px-4 py-2 rounded-full border border-gray-700 text-gray-500 hover:text-primary dark:text-gray-400 text-sm">Malts</button>
                        </div>
                    </div>
                    {/* List Container */}
            ...
            {/* The Cocktail Lab */}
            <section className="py-24 bg-neutral-dark" id="cocktails">
                <div className="max-w-7xl mx-auto px-6">
                    <h2 className="text-4xl font-bold text-white mb-12 flex items-center gap-4">
                        <span className="material-icons text-primary text-4xl">science</span>
                        The Cocktail Lab
                    </h2>
...
const ReserveItem = ({ title, subtitle, region, year, price, image }: any) => (
    <div className="group relative flex flex-col md:flex-row items-baseline justify-between py-6 border-b border-gray-200 dark:border-gray-800 hover:border-primary/50 transition-colors cursor-pointer">
        <div className="md:w-1/2">
            <h4 className="text-xl md:text-2xl font-medium text-gray-900 dark:text-white group-hover:text-primary transition-colors">{title}</h4>
            <p className="text-sm text-gray-500">{subtitle}</p>
        </div>
        <div className="flex justify-between w-full md:w-1/2 mt-2 md:mt-0 text-gray-600 dark:text-gray-400 font-light">
            <span>{region}</span>
            <span>{year}</span>
        ...
        {image && (
            <div className="absolute right-[20%] -top-12 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none z-20 w-32 h-48 hidden lg:block">
    ...
    <div className="group bg-background-dark rounded-xl overflow-hidden shadow-lg hover:shadow-primary/20 transition-all duration-300 border border-transparent hover:border-primary/30">
        <div className="h-64 overflow-hidden relative">
            ...
            <div className="absolute bottom-4 left-4 z-20">
                <span className="bg-primary text-white text-xs font-bold px-2 py-1 rounded">Signature</span>
            </div>
        </div>
        <div className="p-6">
            <h3 className="text-xl font-bold text-white mb-2">{title}</h3>
            <p className="text-gray-400 text-sm mb-4 line-clamp-2">{desc}</p>
            <div className="space-y-2 border-t border-gray-800 pt-4 hidden group-hover:block transition-all animate-fade-in">
            ...
            <button className="mt-4 w-full py-2 rounded border border-gray-700 text-gray-300 hover:text-white hover:border-primary hover:bg-primary/10 text-sm transition-colors">View Method</button>
        </div>
    </div>
);
