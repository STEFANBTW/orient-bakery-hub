...
const AboutScreen: React.FC = () => {
    return (
        <div className="bg-background-light dark:bg-background-dark font-display text-gray-900 dark:text-gray-100 min-h-screen selection:bg-primary selection:text-white antialiased">
            {/* Navigation */}
            <nav className="fixed top-0 left-0 w-full z-50 transition-all duration-300 bg-background-light/90 dark:bg-background-dark/90 backdrop-blur-md border-b border-primary/10">
                <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
                    <a href="#" className="text-3xl font-light italic tracking-tight text-primary">Orient.</a>
                    <div className="hidden md:flex space-x-12 text-lg font-display">
                        <a href="#kitchen" className="hover:text-primary transition-colors duration-300">The Kitchen</a>
                        <a href="#team" className="hover:text-primary transition-colors duration-300">The Brigade</a>
                        <a href="#vibe" className="hover:text-primary transition-colors duration-300">Atmosphere</a>
                        <a href="#farmers" className="hover:text-primary transition-colors duration-300">Origins</a>
                    </div>
                    <button className="bg-primary text-white px-6 py-2 rounded hover:bg-primary/90 transition-colors duration-300 text-lg font-medium font-sans">
                        Reserve
                    </button>
                </div>
            </nav>
            ...
            <section id="farmers" className="py-32 px-6 max-w-6xl mx-auto bg-background-light dark:bg-background-dark">
                <div className="text-center mb-24">
            ...
            {/* Footer / CTA */}
            <footer className="bg-background-dark text-white py-24 border-t border-gray-800">
                <div className="max-w-4xl mx-auto px-6 text-center">
                    <h2 className="text-5xl md:text-7xl font-light mb-8 italic">Taste the Story</h2>
                    <p className="text-xl text-gray-400 mb-12 max-w-xl mx-auto font-sans">
                        Join us for an evening where every dish has a narrator, and you are the audience.
                    </p>
                    <button className="bg-primary text-white text-xl px-12 py-4 rounded hover:bg-primary/90 transition-all duration-300 transform hover:-translate-y-1 shadow-lg shadow-primary/20 font-sans">
                        Book a Table
                    </button>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-24 text-sm text-gray-500 uppercase tracking-widest border-t border-gray-800 pt-12 font-sans">
                        <div>
                            <span className="block text-white mb-2 font-bold">Visit</span>
                            12 Ahmadu Bello Way<br/>Jos, Plateau State
                        </div>
                        <div>
                            <span className="block text-white mb-2 font-bold">Contact</span>
                            +234 800 ORIENT<br/>reservations@orient.com
                        </div>
                        <div>
                            <span className="block text-white mb-2 font-bold">Social</span>
                            <a href="#" className="hover:text-primary mr-4 transition-colors">Instagram</a>
                            <a href="#" className="hover:text-primary transition-colors">Twitter</a>
                        </div>
                    </div>
                    <div className="mt-12 text-gray-700 text-xs font-sans">
                        © 2023 Orient Restaurant. All rights reserved.
                    </div>
                </div>
            </footer>
        </div>
