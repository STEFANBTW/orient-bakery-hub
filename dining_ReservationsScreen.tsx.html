...
const ReservationsScreen: React.FC = () => {
    ...
    return (
        <div className="bg-background-light dark:bg-background-dark text-gray-800 dark:text-gray-100 font-display min-h-screen selection:bg-primary selection:text-white">
            {/* Navigation */}
            <nav className="fixed top-0 w-full z-50 glass-panel border-b border-gray-200 dark:border-white/5">
                <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
                    <div className="text-2xl font-bold tracking-tighter text-gray-900 dark:text-white">ORIENT</div>
                    <div className="hidden md:flex space-x-8 text-sm font-medium text-gray-600 dark:text-gray-300">
                        <a className="hover:text-primary transition-colors" href="#floor-plan">Floor Plan</a>
                        <a className="hover:text-primary transition-colors" href="#occasions">Events</a>
                        <a className="hover:text-primary transition-colors" href="#booking">Book Now</a>
                    </div>
                    <button className="bg-primary hover:bg-primary/90 text-white px-6 py-2 rounded-full font-medium transition-all transform hover:scale-105 shadow-lg shadow-primary/20">
                        Reserve Table
                    </button>
                </div>
            </nav>
            ...
            <section className="relative h-screen w-full overflow-hidden flex items-center justify-center">
                ...
                <div className="relative z-10 text-center px-4 max-w-4xl mx-auto mt-20 animate-fade-in-up">
                    <span className="text-primary font-medium tracking-widest uppercase mb-4 block">Welcome to Orient</span>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <a className="bg-primary text-white px-8 py-4 rounded-lg font-semibold text-lg hover:bg-primary/90 transition-all flex items-center justify-center gap-2 shadow-lg shadow-primary/20" href="#floor-plan">
                            <span className="material-icons text-xl">table_restaurant</span>
                            Pick Your Spot
                        </a>
                        <a className="bg-white/50 dark:bg-white/10 backdrop-blur-md text-gray-900 dark:text-white border border-gray-200 dark:border-white/20 px-8 py-4 rounded-lg font-semibold text-lg hover:bg-white/60 dark:hover:bg-white/20 transition-all flex items-center justify-center gap-2" href="#occasions">
            ...
            <section className="py-24 px-6 relative bg-white dark:bg-background-dark transition-colors" id="floor-plan">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">Select Your Table</h2>
                        <p className="text-gray-500 dark:text-gray-400">Hover over the map to see table details. Green indicates availability.</p>
                        {/* Legend */}
                        <div className="flex items-center justify-center gap-6 mt-8 text-sm">
                            <div className="flex items-center gap-2">
                                <div className="w-4 h-4 rounded-full bg-white dark:bg-surface-dark border border-gray-300 dark:border-white/30"></div>
                    ...
                    {/* Map Container */}
                    <div ref={mapRef} className="relative bg-gray-100 dark:bg-surface-dark border border-gray-200 dark:border-white/5 rounded-2xl p-8 overflow-hidden shadow-2xl transition-colors">
                        {/* Tooltip */}
                        <div 
            ...
            <section className="py-24 bg-gray-50 dark:bg-surface-dark transition-colors" id="occasions">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="text-center mb-20">
                        <span className="text-primary font-bold uppercase tracking-widest text-sm">Beyond Dining</span>
                        <h2 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mt-2">Special Occasions</h2>
                    </div>
                    {/* Content Blocks */}
                    <div className="space-y-24">
                        ...
                        <div className="flex flex-col md:flex-row gap-12 items-center">
                            ...
                            <div className="w-full md:w-1/2 space-y-6">
                                ...
                                <ul className="space-y-3 text-gray-500 dark:text-gray-400">
                                    <li className="flex items-center gap-2"><span className="text-primary material-icons text-sm">check_circle</span> Private booth options</li>
                                    <li className="flex items-center gap-2"><span className="text-primary material-icons text-sm">check_circle</span> Custom cake pre-ordering</li>
                                    <li className="flex items-center gap-2"><span className="text-primary material-icons text-sm">check_circle</span> Dedicated server</li>
                                </ul>
                                <button className="text-primary font-semibold hover:text-orange-600 dark:hover:text-white transition-colors flex items-center gap-2 group">
                        ...
                        <div className="flex flex-col md:flex-row-reverse gap-12 items-center">
                            ...
                            <div className="w-full md:w-1/2 space-y-6">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="bg-white dark:bg-background-dark p-4 rounded-lg border border-gray-200 dark:border-white/5 shadow-sm">
                                        <span className="text-primary font-bold text-xl block mb-1">12-40</span>
                                        <span className="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wide">Guests</span>
                                    </div>
                                    <div className="bg-white dark:bg-background-dark p-4 rounded-lg border border-gray-200 dark:border-white/5 shadow-sm">
                                        <span className="text-primary font-bold text-xl block mb-1">AV/Tech</span>
                                        <span className="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wide">Available</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col md:flex-row gap-12 items-center">
                            ...
                            <div className="w-full md:w-1/2 space-y-6">
                                ...
                                <button className="bg-gray-100 dark:bg-white/10 hover:bg-gray-200 dark:hover:bg-white/20 text-gray-900 dark:text-white px-6 py-3 rounded-lg border border-gray-200 dark:border-white/10 transition-all">
                                    View Sample Menu
                                </button>
                            </div>
                        </div>
                    ...
                    {/* Mini Gallery */}
                    <div className="mt-24">
                        <h4 className="text-2xl font-bold text-gray-900 dark:text-white mb-8 border-l-4 border-primary pl-4">Past Events Gallery</h4>
            ...
            <section className="py-24 bg-white dark:bg-background-dark relative overflow-hidden transition-colors" id="booking">
                {/* Decorative Background Element */}
                <div className="absolute top-0 right-0 w-1/3 h-full bg-gradient-to-l from-primary/5 to-transparent pointer-events-none"></div>
                <div className="max-w-5xl mx-auto px-6 relative z-10">
                    <div className="mb-12 text-center">
                        <h2 className="text-4xl font-bold text-gray-900 dark:text-white">Finalize Your Reservation</h2>
                        <p className="text-gray-500 dark:text-gray-400 mt-2">Secure your spot at Orient in 3 simple steps.</p>
                    </div>
                    {/* Wizard Steps Header */}
                    <div className="flex justify-between mb-12 relative">
                        ...
                        {/* Step 1 Indicator */}
                        <div className="flex flex-col items-center gap-2 bg-white dark:bg-background-dark px-4 z-10">
                            <div className="w-10 h-10 rounded-full bg-primary text-white flex items-center justify-center font-bold border-4 border-white dark:border-background-dark shadow-lg shadow-primary/30">1</div>
                            <span className="text-sm font-medium text-gray-900 dark:text-white">Date & Time</span>
                        </div>
                        {/* Step 2 Indicator */}
                        <div className="flex flex-col items-center gap-2 bg-white dark:bg-background-dark px-4 z-10">
                            <div className="w-10 h-10 rounded-full bg-gray-100 dark:bg-surface-dark border border-gray-300 dark:border-gray-600 text-gray-400 flex items-center justify-center font-bold border-4 border-white dark:border-background-dark">2</div>
                            <span className="text-sm font-medium text-gray-500">Preferences</span>
                        </div>
                        {/* Step 3 Indicator */}
                        <div className="flex flex-col items-center gap-2 bg-white dark:bg-background-dark px-4 z-10">
                            <div className="w-10 h-10 rounded-full bg-gray-100 dark:bg-surface-dark border border-gray-300 dark:border-gray-600 text-gray-400 flex items-center justify-center font-bold border-4 border-white dark:border-background-dark">3</div>
                            <span className="text-sm font-medium text-gray-500">Contact</span>
                        </div>
                    </div>
                    {/* Form Container */}
                    <div className="bg-gray-50 dark:bg-surface-dark border border-gray-200 dark:border-white/5 rounded-2xl p-8 md:p-12 shadow-2xl transition-colors">
                        {/* STEP 1 CONTENT */}
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                            <div className="space-y-6">
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Select Date</label>
                                    <input className="w-full bg-white dark:bg-background-dark border border-gray-300 dark:border-gray-700 rounded-lg p-3 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary focus:border-transparent accent-primary" type="date" defaultValue="2023-10-24"/>
                                </div>
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Guests</label>
                                    <div className="flex gap-4">
                                        <button className="w-12 h-12 rounded-lg bg-white dark:bg-background-dark border border-gray-300 dark:border-gray-700 hover:border-primary text-gray-700 dark:text-white flex items-center justify-center transition-colors">2</button>
                                        <button className="w-12 h-12 rounded-lg bg-primary border border-primary text-white flex items-center justify-center shadow-lg shadow-primary/20">4</button>
                                        <button className="w-12 h-12 rounded-lg bg-white dark:bg-background-dark border border-gray-300 dark:border-gray-700 hover:border-primary text-gray-700 dark:text-white flex items-center justify-center transition-colors">6</button>
                                        <button className="w-12 h-12 rounded-lg bg-white dark:bg-background-dark border border-gray-300 dark:border-gray-700 hover:border-primary text-gray-700 dark:text-white flex items-center justify-center transition-colors">8+</button>
                                    </div>
                                </div>
                            </div>
                            <div>
                        ...
                        {/* Navigation Buttons */}
                        <div className="flex justify-end mt-12 pt-8 border-t border-gray-200 dark:border-white/5">
                            <button className="bg-primary hover:bg-primary/90 text-white px-8 py-3 rounded-lg font-bold transition-all shadow-lg shadow-primary/20 flex items-center gap-2">
            ...
            <div className="fixed bottom-24 right-6 z-50 group">
                <div className="absolute right-full mr-4 top-1/2 -translate-y-1/2 bg-gray-900 dark:bg-surface-dark px-3 py-1 rounded text-xs text-white whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity border border-white/10">
                    Ask The Concierge
                </div>
