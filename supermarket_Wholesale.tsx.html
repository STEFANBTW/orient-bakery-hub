...
const Wholesale: React.FC = () => {
  ...
  return (
    <div className="font-sans bg-[#f8f7f5] dark:bg-slate-950 min-h-screen flex flex-col text-slate-800 dark:text-slate-200 transition-colors duration-300">
      {/* Header */}
      <header className="sticky top-0 z-50 bg-white dark:bg-slate-900 border-b border-gray-200 dark:border-slate-800 h-16 flex items-center px-6 shadow-sm justify-between max-w-[1600px] w-full mx-auto transition-colors duration-300">
        ...
        <main className="flex-1 flex flex-col overflow-hidden">
           ...
           <div className="shrink-0 bg-white dark:bg-slate-900 border-b border-gray-200 dark:border-slate-800 px-8 py-6 relative overflow-hidden transition-colors duration-300">
              ...
              <div className="relative z-10 flex justify-between items-center">
                ...
                <div className="flex gap-3">
                   ...
                   <motion.button whileTap={{ scale: 0.95 }} className="flex items-center gap-2 px-4 py-2 bg-[#ff6a00] text-white rounded-lg text-sm font-medium hover:bg-orange-600 shadow-sm transition-colors">
           ...
           <div className="flex-1 overflow-auto bg-white dark:bg-slate-900 transition-colors duration-300">
              <table className="w-full text-left border-collapse">
                 <thead className="bg-slate-50 dark:bg-slate-800 sticky top-0 z-20 shadow-sm transition-colors duration-300">
                   <tr>
                     ...
                     >
                        ...
                        <td className="py-2 px-4">
                            <span 
                                ...
                                className="px-2 py-0.5 rounded bg-[#ff6a00]/10 text-[#ff6a00] text-xs font-bold border border-[#ff6a00]/20 cursor-help"
                            >
                                {item.tierInfo || 'Std'}
                            </span>
                        </td>
                        ...
                        <td className="py-2 px-4 text-center">
                           <div className="flex items-center justify-center border border-gray-300 dark:border-slate-700 rounded bg-white dark:bg-slate-800 max-w-[100px] mx-auto">
                              <button onClick={() => updateLocalQty(item.id, -1)} className="px-2 py-1 text-slate-400 hover:text-[#ff6a00] hover:bg-gray-100 dark:hover:bg-slate-700 transition-colors">-</button>
                        ...
                        <td className="py-2 px-4 text-center">
                            <button onClick={() => handleAddToOrder(item)} className="text-[#ff6a00] hover:bg-[#ff6a00] hover:text-white p-2 rounded transition-colors font-bold text-xs uppercase border border-[#ff6a00]">Add</button>
                        </td>
                     </motion.tr>
                   ))}
                   </AnimatePresence>
        ...
        >
           ...
           <div className="p-6 space-y-4 border-t border-gray-200 dark:border-slate-800">
              ...
              <div className="flex justify-between items-end">
                 ...
                 <span className="text-2xl font-bold text-[#ff6a00]">${cart.wholesaleSubtotal.toFixed(2)}</span>
              </div>
              <motion.button whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} className="w-full bg-[#ff6a00] hover:bg-orange-600 text-white font-bold py-3 rounded shadow-lg flex items-center justify-center gap-2 transition-colors">
