  ...
  return (
    <div className="bg-[#050505] text-white font-inter overflow-x-hidden selection:bg-primary-gold selection:text-black">
      ...
      <section className="relative h-screen w-full flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-6">
            <Link to="/booking" className="bg-primary-gold text-black px-12 py-5 rounded-sm uppercase tracking-[0.2em] text-[11px] font-bold hover:bg-white transition-all shadow-xl">
              Reserve a Table
            </Link>
      ...
      <section className="relative py-32 bg-black border-t border-white/5 overflow-hidden" id="mixology">
        ...
        <div className="flex overflow-x-auto hide-scrollbar pb-16 px-6 snap-x snap-mandatory gap-8 md:gap-16 w-full">
          {[
            { 
            ...
            <div key={i} className="snap-center shrink-0 w-[85vw] md:w-[600px] relative group">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="flex overflow-x-auto gap-8 pb-10 hide-scrollbar snap-x snap-mandatory">
            {[
              ...
              <div key={zone.name + i} className="snap-start shrink-0 w-[300px] md:w-[420px] group relative">
      ...
      <footer className="py-24 px-12 bg-black border-t border-white/5">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16">
          <div className="space-y-6 text-center md:text-left">
            <h4 className="font-serif italic text-3xl text-white">Orient Lounge</h4>
            <p className="text-[11px] text-gray-500 uppercase tracking-widest leading-loose">
              1002 Tear Palace. District 1 <br/> Monopurity, MT 10012 <br/> United States
            </p>
            <div className="flex gap-6 justify-center md:justify-start">
              <span className="text-[10px] uppercase tracking-[0.4em] text-gray-400 cursor-pointer hover:text-primary-gold transition-colors">Instagram</span>
              <span className="text-[10px] uppercase tracking-[0.4em] text-gray-400 cursor-pointer hover:text-primary-gold transition-colors">X</span>
              <span className="text-[10px] uppercase tracking-[0.4em] text-gray-400 cursor-pointer hover:text-primary-gold transition-colors">LinkedIn</span>
            </div>
          </div>
          
          <div className="space-y-6">
            <h5 className="text-[10px] uppercase tracking-[0.4em] text-primary-gold font-bold">Exploration</h5>
            <ul className="space-y-4 text-xs font-light text-gray-400">
              <li><Link to="/experience" className="hover:text-white transition-colors">The Experience</Link></li>
              <li><Link to="/menu" className="hover:text-white transition-colors">Signature Menu</Link></li>
              <li><Link to="/booking" className="hover:text-white transition-colors">Private Events</Link></li>
              <li><a href="#" className="hover:text-white transition-colors">Press & Media</a></li>
            </ul>
          </div>

          <div className="space-y-6">
            <h5 className="text-[10px] uppercase tracking-[0.4em] text-primary-gold font-bold">Contact</h5>
            <ul className="space-y-4 text-xs font-light text-gray-400">
              <li><a href="mailto:concierge@orientlounge.com" className="hover:text-white transition-colors">concierge@orientlounge.com</a></li>
          ...
          <div className="space-y-6">
            <h5 className="text-[10px] uppercase tracking-[0.4em] text-primary-gold font-bold">The Noir Letter</h5>
            <p className="text-xs text-gray-500 font-light leading-relaxed">Join our inner circle for exclusive event invitations and cellar releases.</p>
            <div className="flex">
               <input type="email" placeholder="Email Address" className="bg-white/5 border border-white/10 text-xs px-4 py-3 rounded-l-sm outline-none focus:border-primary-gold w-full" />
               <button className="bg-primary-gold text-black px-4 py-3 rounded-r-sm text-[10px] font-bold uppercase tracking-widest">Join</button>
            </div>
          </div>
        </div>
        
        <div className="max-w-7xl mx-auto mt-20 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-[10px] text-gray-700 uppercase tracking-widest">© 2023 The Orient Group • All Frequencies Reserved</p>
          <div className="flex gap-8 text-[9px] text-gray-700 uppercase tracking-widest">
